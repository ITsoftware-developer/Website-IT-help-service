...
const revealTargets = document.querySelectorAll(
  ".section-heading, .service-card, .device-card, .info-grid article, .detail-grid article, .steps li, .contact-card, .appointment-form, .form-aside, .sales-strip div, .home-cta-section"
);
